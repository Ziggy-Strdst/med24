...
$(function () {
  ...
  $('.header__toggle').on('click', function (e) {
    ...
    $(this)
      .find('.header__toggle-link')
      .toggleClass('header__toggle-link--active');
    $('.overlay-bg').toggleClass('overlay-bg--active');
  ...
  $('.hero__slider').slick({
    ...
    dots: false,
    prevArrow:
      '<a href="javascript:void(0);" class="hero__arrow hero__arrow--prev"><span class="i-m i-m-arrow-right"></span></a>',
    nextArrow:
      '<a href="javascript:void(0);" class="hero__arrow hero__arrow--next"><span class="i-m i-m-arrow-right"></span></a>',
  });

  // $("form.form__left").on("submit", function (e) {
  // e.preventDefault();

  // $(this).siblings(".form__right").addClass("form__right--active");
  // });
  ...
  $('.wiki__link').on('click', function (e) {
    ...
    $(this).siblings('.wiki__content').slideToggle('middle');
    $(this).toggleClass('wiki__link--active');
  });
  ...
  $('.about__slider').slick({
    ...
    dots: true,
    prevArrow:
      '<a href="javascript:void(0);" class="about__arrow about__arrow--prev"><span class="i-m i-m-arrow-right"></span></a>',
    nextArrow:
      '<a href="javascript:void(0);" class="about__arrow about__arrow--next"><span class="i-m i-m-arrow-right"></span></a>',
    responsive: [
      {
        breakpoint: 992,
        settings: {
  ...
  $('.gallery__slider').slick({
    ...
    dots: false,
    prevArrow:
      '<a href="javascript:void(0);" class="gallery__arrow gallery__arrow--prev">Ранее</a>',
    nextArrow:
      '<a href="javascript:void(0);" class="gallery__arrow gallery__arrow--next">Далее</a>',
    responsive: [
      {
        breakpoint: 1170,
        settings: {
  ...
  // if($(window).width() < 991) {
  $('.menu__item a span.i-m').on('click', function (e) {
    e.preventDefault();

    if ($(this).parent().parent().hasClass('acctive')) {
      $(this).parent().siblings('ul').slideToggle(100);
      $(this).parent().parent().removeClass('acctive');
    } else {
      $('.menu__item').removeClass('acctive');
      $('.menu__item ul').hide(100);
      $(this).parent().parent().addClass('acctive');
      $(this).parent().siblings('ul').slideToggle(100);
    }
  });
  // }
